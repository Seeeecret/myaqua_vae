...
# 选择采样的数据路径
reconstructed_lora_vector = torch.load(rank64_kld_weight_0005_path1_1204)
...
torch.save(restored_state_dict, './output/rank64_alter3_kld_weight_0005_1204/restored_state_dict.pth')
save_file(restored_state_dict, './output/rank64_alter3_kld_weight_0005_1204/pytorch_lora_weights.safetensors')
