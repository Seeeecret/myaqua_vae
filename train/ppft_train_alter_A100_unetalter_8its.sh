...
accelerate launch --mixed_precision="fp16" ppft_train_alter_A100_unetalter.py \
  ...
  --seed=2048 \
  --output_dir="/baai-cwm-1/baai_cwm_ml/public_data/scenes/lightwheelocc-v1.0/vae_data/rank8_bits8_output_0321" \
