...
def save_lora_weights_step(output_dir, unet, text_encoder, step):
...
def import_model_class_from_model_name_or_path(pretrained_model_name_or_path: str):
    text_encoder_config = PretrainedConfig.from_pretrained(
        "/NEW_EDS/JJ_Group/shaoyh/dorin/AquaLoRA/checkpoints/stable-diffusion-v1-5",
...
def main(args):
    ...
    if args.tokenizer_name:
        tokenizer = AutoTokenizer.from_pretrained("/NEW_EDS/JJ_Group/shaoyh/dorin/AquaLoRA/checkpoints/stable-diffusion-v1-5/tokenizer", revision=args.revision, use_fast=False,local_files_only=True)
