...
if __name__ == "__main__":
    ...
    generator = WatermarkedImageGenerator(base_model='/baai-cwm-1/baai_cwm_ml/public_data/scenes/lightwheelocc-v1.0/stable-diffusion-v1-5',lora_path='watermarked_lora.safetensors')
    # 从../../evaluation/prompts.txt加载生成文本
    with open("./prompt.txt") as f:
        prompts = f.readlines()

    generator.generate_batch(prompts,output_dir='/baai-cwm-1/baai_cwm_ml/public_data/scenes/lightwheelocc-v1.0/vae_data/V6output/sampleDataset', num_images=1000)
