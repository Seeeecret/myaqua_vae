...
rank4_kld_weight_0005_path1 = './generated_samples/rank4_kld_weight_0005/20241122/sample_1.pth'
rank4_kld_weight_0005_path2 = './generated_samples/rank4_kld_weight_0005/20241122/sample_2.pth'


# 选择采样的数据路径
reconstructed_lora_vector = torch.load(rank4_kld_weight_0005_path1)
...
data_file = '/mnt/share_disk/dorin/AquaLoRA/checkpoints/lora_weights_dataset/rank4_extracted_lora_weights/normalized_data/normalized_pytorch_lora_weights_37499.pth'
...
sample_1_path = rank4_kld_weight_0005_path1
flattened_data = torch.load(sample_1_path)
...
if not os.path.exists('./output/rank4_alter3_kld_weight_0005'):
    os.makedirs('./output/rank4_alter3_kld_weight_0005')
torch.save(restored_state_dict, './output/rank4_alter3_kld_weight_0005/restored_state_dict.pth')
save_file(restored_state_dict, './output/rank4_alter3_kld_weight_0005/pytorch_lora_weights.safetensors')
