...
vae = OneDimVAE(latent_dim=latent_dim, input_length=input_length, kld_weight=0.0005).to(device)
...
# 打印前 100 个值对比
print("Original Data (first 100 values):", test_data.flatten()[:100].tolist())
print("Reconstructed Data (first 100 values):", reconstructed_data.flatten()[:100].tolist())
