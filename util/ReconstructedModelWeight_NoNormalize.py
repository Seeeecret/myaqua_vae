...
SHAO_NoNormalize_encodeDecodeNormalizedData_path = '/mnt/share_disk/dorin/AquaLoRA/output/SHAO_alter3_kld_weight_0005_1209/reconstructed_flat_adapter_model_31/reconstructed_data.pth'

# TODO：选择采样的数据路径
reconstructed_lora_vector = torch.load(SHAO_NoNormalize_encodeDecodeNormalizedData_path)
...
# TODO:Load the data dictionary from the selected file
...
# TODO: 修改
save_path = '../output/encodedecode_SHAO_alter3_kld_weight_0005_1209'
