...
# 分类所有层
category_diffs = {i: [] for i in range(1, def_categories.__len__() + 1)}  # 初始化添加新类别
category_cosine_sims = {i: [] for i in range(1, def_categories.__len__() + 1)}  # 初始化添加新类别
uncategorized_keys = []
...
for i in range(1, def_categories.__len__() + 1):
